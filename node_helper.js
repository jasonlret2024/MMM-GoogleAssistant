...
module.exports = NodeHelper.create({
  ...
  socketNotificationReceived: function (notification, payload) {
    if (notification === "SHOW_INDICATOR") {
      if (payload.show) {
        this.showIndicatorOnScreen();
      } else {
        this.hideIndicatorOnScreen();
      }
    }
  },

  showIndicatorOnScreen: function () {
    // Send a notification to the MagicMirror frontend to show a visual indicator
    this.sendNotification("SHOW_GOOGLE_INDICATOR");
  },

  hideIndicatorOnScreen: function () {
    // Send a notification to the MagicMirror frontend to hide the indicator
    this.sendNotification("HIDE_GOOGLE_INDICATOR");
  }
});
